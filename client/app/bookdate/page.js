...
export default function Home() {
  ...
  <main className='w-screen h-screen flex flex-col items-center justify-center bg-teal-900'>
    <div className='p-1 bg-red-50 w-3/5 h-5/7 rounded-2xl'>
      <form className='p-3' action='/insurance'>
        <div class="space-y-2">
          <h2 class="text-base font-semibold leading-7 text-gray-900">Date Booking</h2>
          ...
          <div class="col-span-full">
            ...
            <div class="flex items-center justify-end gap-x-6 mt-5">
              <a href='/booking'><button type="button" class="text-sm font-semibold leading-6 text-gray-900">Back</button></a>
